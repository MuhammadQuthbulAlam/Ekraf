...
import slide_image_2 from "../assets/images/profile-1.jpg";
import slide_image_3 from "../assets/images/profile-1.jpg";
import slide_image_4 from "../assets/images/profile-1.jpg";
import slide_image_5 from "../assets/images/profile-1.jpg";
        ...
        <div className="profile pt-32 z-50" id="profile">
          ...
          <div className="profile-box pt-12 grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-6">
            ...
            <div className="box p-2 bg-white shadow rounded-lg">
              ...
              <h3 className="text-xl font-bold mt-6 mb-2">Ari Budiyanto</h3>
              <p className=" text-base/loose">Food Photography</p>
              <button
                onClick={() => setVisible(true)}
                type="submit"
                className="flex mt-20 px-5 mx-auto bg-sky-400 py-1 rounded-full text-white font-bold hover:bg-sky-500 transition-all"
              >
                Detail Info
              </button>
              {/*Model 1 Start*/}
              ...
              >
                <h2 className="text-center lg:text-5xl/tight text-3xl font-medium mb-2">
                  Detail <span className="font-bold text-sky-400">Info</span>
                </h2>
                <img
                  src={Profile1}
                  alt="profile 1"
                  className="items-center h-60 w-60 rounded-lg"
                />
                <button
                  onClick={() => setVisible(true)}
                  type="submit"
            ...
            {/* Profile 2 Start*/}
            <div className="box p-2 bg-white shadow rounded-lg">
              <img src={Profile1} alt="Profile 2" className="rounded-lg" />
              <h3 className="text-xl font-bold mt-6 mb-2">Jui Hasan</h3>
              <p className=" text-base/loose">Ecoprint</p>
              <button
                onClick={() => setVisible(true)}
                type="submit"
                className="flex mt-20 px-5 mx-auto bg-sky-400 py-1 rounded-full text-white font-bold hover:bg-sky-500 transition-all"
